...
public:
    ...
    // What the re-NACK helper needs to know about an incomplete frame.
    struct FrameView {
...
private:
    ...
    struct Frame {
        ...
        bool renacked = false;  // the one repeat NACK for this frame went out
    ...
    /* Rate limit for the "blind" diagnostic in the discard path. */
    int discards_since_log_ = 0;
